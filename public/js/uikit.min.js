...
!function (t, e) {
    ...
    var _t = ct ? Element.prototype : {}, At = _t.matches || _t.webkitMatchesSelector || _t.msMatchesSelector || Q;
    ...
    var Rt = /(^|[^\\],)\s*[!>+~-]/, qt = /([!>+~-])(?=\s+[!>+~-]|\s*$)/g, Ut = rt(function (t) {
        return t.match(Rt)
    }), Yt = /.*?[^\\](?:,|$)/g, Xt = rt(function (t) {
    ...
    function Jt() {
        ...
        var n, i, r = ne(t), o = r[0], s = r[1], a = r[2], u = r[3], c = r[4], o = se(o);
    ...
    function Qt() {
        for (var t = [], e = arguments.length; e--;) t[e] = arguments[e];
        var n = ne(t), i = n[0], r = n[1], o = n[2], s = n[3], a = n[4], u = n[5], c = Jt(i, r, o, function (t) {
            var e = !u || u(t);
            e && (c(), s(t, e))
        }, a);
        return c
    ...
    var he = ct && window.Promise || fe, le = 2, de = ct && window.setImmediate || setTimeout;
    ...
    pe.resolve = function (t) {
        ...
        de(function () {
            if (r.state !== le) for (; r.deferred.length;) {
                var e = r.deferred.shift(), t = e[0], n = e[1], i = e[2], e = e[3];
                try {
    ...
    function Je(t, s, a, u) {
        return void 0 === a && (a = 400), void 0 === u && (u = "linear"), he.all(W(t).map(function (o) {
            return new he(function (e, n) {
                ...
                }, {self: !0}), Be(o, "uk-transition"), Re(o, Y({
    ...
    function tn(t, o, s, a, u) {
        return void 0 === s && (s = 200), he.all(W(t).map(function (r) {
            return new he(function (e, n) {
                ...
                }, {self: !0}), Re(r, "animationDuration", s + "ms"), Be(r, o, Qe + (u ? "leave" : "enter")), g(o, Qe) && (a && Be(r, "uk-transform-origin-" + a), u && Be(r, Qe + "reverse"))
            })
        }))
    }

    var en = new RegExp(Qe + "(enter|leave)"), nn = {
        in: tn, out: function (t, e, n, i) {
            return tn(t, e, n, i, !0)
        }, inProgress: function (t) {
    ...
    function sn(n, i) {
        var t, r = on(n), e = V(n), o = {height: e.pageYOffset, width: e.pageXOffset};
    ...
    function Cn(t) {
        if (zn(t) && Dn(t, {func: "playVideo", method: "play"}), Mn(t)) try {
            t.play().catch(Q)
        } catch (t) {
        }
    }
    ...
    var Pn = "_ukPlayer", Hn = 0;

    function Ln(t, r, o) {
        return void 0 === r && (r = 0), void 0 === o && (o = 0), !!$t(t) && tt.apply(void 0, Vn(t).map(function (t) {
            var e = sn(Rn(t)), n = e.top, i = e.left, t = e.bottom, e = e.right;
    ...
    function Fn(s, t) {
        ...
        return u.reduce(function (t, e, n) {
            var i = e.scrollTop, r = e.scrollHeight - qn(e),
    ...
    function Wn(t, e) {
        ...
        var n = Vn(t, /auto|scroll/, !0)[0], i = n.scrollHeight, r = n.scrollTop, o = qn(n),
            s = un(t)[0] - r - un(n)[0], n = Math.min(o, s + r);
        return Z(-1 * (s - n) / Math.min(t.offsetHeight + e + n, i - (s + r), i - o))
    }

    function Vn(t, e, n) {
        void 0 === e && (e = /auto|scroll|hidden/), void 0 === n && (n = !1);
        var i = Un(t), r = Dt(t).reverse(), t = x(r = r.slice(r.indexOf(i) + 1), function (t) {
    ...
    var ti, ei, ni, ii, ri, oi, si, ai, ui, ci = rt(function (t) {
    ...
    Qn.util = Zn, Qn.data = "__uikit__", Qn.prefix = "uk-", Qn.options = {}, Qn.version = "3.7.3", ni = (ti = Qn).data, ti.use = function (t) {
        ...
        void 0 === t && (t = "update"), this._connected && ("update" !== t && "resize" !== t || this._callWatches(), this.$options.update && (this._updates || (this._updates = new Set, gn.read(function () {
            e._connected && !function (i) {
                for (var r = this, o = this.$options.update, t = 0; t < o.length; t++) !function (t) {
                    var e = o[t], t = e.read, n = e.write, e = e.events;
        ...
        this._watch || (t = !c(this, "_watch"), this._watch = gn.read(function () {
            e._connected && !function (t) {
                var e, n = this.$options.computed, i = this._computeds;
                for (e in n) {
                    var r = c(i, e), o = i[e];
                    delete i[e];
                    var s = n[e], a = s.watch, s = s.immediate;
        ...
        events: [{
            name: "click", delegate: function () {
                return this.targets + " " + this.$props.toggle
                 ...
                 this.toggle(Pt(this.toggles, t.current))
            }
        }],
        methods: {
            toggle: function (t, r) {
                var o = this, e = [this.items[it(t, this.items)]], t = Ct(this.items, "." + this.clsOpen);
    ...
    var ki, $i = {
        ...
        events: [{
            ...
            name: "click", delegate: function () {
                ...
                var e = t.defaultPrevented, t = t.current.hash;
            ...
            name: "show", self: !0, handler: function () {
                ...
                }), {self: !0}), Qt(this.$el, "hide", Jt(document, "keydown", function (t) {
        ...
        methods: {
            show: function (t, e) {
                ...
                var t, e = sn(this.boundary), n = this.boundaryAlign ? e : sn(this.target);
    ...
    function Ai(t, e, n) {
        for (var i = [[]], r = 0; r < t.length; r++) {
            ...
            if ($t(o)) for (var s = Mi(o), a = i.length - 1; 0 <= a; a--) {
                ...
                var c = void 0, c = u[0].offsetParent === o.offsetParent ? Mi(u[0]) : (s = Mi(o, !0), Mi(u[0], !0));
    ...
    function Mi(t, e) {
        var n = t.offsetTop, i = t.offsetLeft, r = t.offsetHeight, o = t.offsetWidth;
    ...
    var zi = {
        ...
        update: [{
            ...
            read: function (t) {
                ...
                var i, r, o = !1, s = Ot(this.$el), a = e.map(function (t) {
                ...
                return {
                    ...
                    }, 0), columns: e, translates: o, height: o ? c : ""
                }
            }, write: function (t) {
                var e = t.height, t = t.padding;
            ...
            read: function (t) {
                ...
                var e = t.columns, i = t.scrolled, r = t.translates;
    ...
    function Oi(t) {
        ...
        var n = t.map(Pi), i = Math.max.apply(Math, n), e = t.some(function (t) {
    ...
    var Hi = {
        ...
        update: {
            read: function (t) {
                ...
                var n = "", i = dn(this.$el, "height", "content-box");
    ...
    var Fi = /<symbol([^]*?id=(['"])(.+?)\2[^]*?<\/)symbol>/g, Wi = {};
    ...
    var Yi = {
        ...
        args: !1, extends: Xi, data: function (t) {
            return {icon: d(t.constructor.options.name)}
        }, beforeConnect: function () {
            Be(this.$el, this.$name)
        }
    }, Ki = {
        extends: Gi, beforeConnect: function () {
    ...
    var er = {
        ...
        computed: {
            cacheKey: function (t) {
                ...
                var e = t.width, t = t.dataWidth;
                return e || t
            }, height: function (t) {
                var e = t.height, t = t.dataHeight;
                return e || t
            }, sizes: function (t) {
                var e = t.sizes, t = t.dataSizes;
                return e || t
            }, isImg: function (t, e) {
                return ur(e)
            }, target: {
        ...
        connected: function () {
            ...
            }(this.width, this.height, this.sizes)), this.observer = new IntersectionObserver(this.load, {rootMargin: this.offsetTop + "px " + this.offsetLeft + "px"}), requestAnimationFrame(this.observe)) : nr(this.$el, this.dataSrc, this.dataSrcset, this.sizes)
        },
        disconnected: function () {
    ...
    function nr(n, t, e, i) {
        ...
        })("sizes", i), r("srcset", e), r("src", t)) : t && !w(n.style.backgroundImage, t) && (Re(n, "backgroundImage", "url(" + Kt(t) + ")"), te(n, ee("load", !1)))
    }
    ...
    var fr = {
        ...
        events: [{
            ...
            name: "show", self: !0, handler: function () {
                var r = this, t = document.documentElement;
                ...
                }), {self: !0}), this.escClose && Qt(this.$el, "hide", Jt(document, "keydown", function (t) {
    ...
    var vr = {
        install: function (t) {
            ...
            function i(t, e, n, i) {
                ...
                var r = a.dialog(t(e), e), o = new ce, s = !1;
    ...
    o = ".uk-navbar-nav > li > a, .uk-navbar-item, .uk-navbar-toggle", l = {
        ...
        computed: {
            boundary: function (t, e) {
                var n = t.boundary, t = t.boundaryAlign;
                return !0 === n || t ? e : n
        ...
        events: [{
            name: "mouseover", delegate: function () {
                ...
                var e = t.current, t = this.getActive();
        ...
        methods: {
            getActive: function () {
                ...
                var n = this, i = this.dropbar, r = $t(i) ? cn(i) : 0;
                return Re(e = r < t && e, "clip", "rect(0," + e.offsetWidth + "px," + r + "px,0)"), cn(i, r), Ze.cancel([e, i]), he.all([Ze.start(i, {height: t}, this.duration), Ze.start(e, {clip: "rect(0," + e.offsetWidth + "px," + t + "px,0)"}, this.duration)]).catch(Q).then(function () {
        ...
        computed: {
            clsFlip: function (t) {
                var e = t.flip, t = t.clsFlip;
                return e ? t : ""
            }, clsOverlay: function (t) {
                var e = t.overlay, t = t.clsOverlay;
                return e ? t : ""
            }, clsMode: function (t) {
                var e = t.mode;
                return t.clsMode + "-" + e
            }, clsSidebarAnimation: function (t) {
                var e = t.mode, t = t.clsSidebarAnimation;
                return "none" === e || "reveal" === e ? "" : t
            }, clsContainerAnimation: function (t) {
                var e = t.mode, t = t.clsContainerAnimation;
    ...
    var dt = {
        ...
        update: {
            read: function () {
                return !!(this.content && this.container && $t(this.$el)) && {
                    ...
                    max: Math.max(this.minHeight, cn(this.container) - (on(this.content).height - cn(this.$el)))
                }
            }, write: function (t) {
                var e = t.current, t = t.max;
        ...
        props: {offset: Number}, data: {offset: 0}, methods: {
            scrollTo: function (t) {
                var e = this;
                t = t && Me(t) || document.body, te(this.$el, "beforescroll", [this, t]) && Fn(t, {offset: this.offset}).then(function () {
        ...
        update: [{
            read: function () {
                ...
                var i = Vn(this.targets, /auto|scroll/, !0)[0], e = i.scrollTop, r = i.scrollHeight - qn(i), o = !1;
                ...
                var e = t.active, t = !1 !== e && !He(this.elements[e], this.cls);
        ...
        events: [{
            name: "load hashchange popstate", el: function () {
                ...
                !1 !== this.targetOffset && location.hash && 0 < window.pageYOffset && ((i = Me(location.hash)) && gn.read(function () {
                    var t = sn(i).top, e = sn(r.$el).top, n = r.$el.offsetHeight;
        ...
        update: [{
            read: function (t, e) {
                ...
                var e = t.height, n = t.margins, t = this.placeholder;
            ...
            read: function (t) {
                ...
                void 0 === o && (o = 0);
                var s = t.dir, a = t.lastDir, u = t.lastScroll, c = t.scroll, e = t.top;
    ...
    function xr(t, e) {
        var n = e.$props, i = e.$el, e = e[t + "Offset"], t = n[t];
    ...
    var yr, kr, $r, lr = {
        ...
        methods: {
            index: function () {
                ...
                var n = this, i = this.index(), r = it(this.children[it(t, this.toggles, i)], Ot(this.$el));
        ...
        events: [{
            name: mt + " " + vt + " " + xt, filter: function () {
                return w(this.mode, "hover")
            }, handler: function (t) {
                this._isTouch = ae(t) && t.type === mt
            }
        }, {
            name: wt + " " + bt + " focus blur", filter: function () {
                ...
                var e;
                ae(t) || this._isTouch || (!(e = w(["pointerleave", "pointerenter"], t.type)) && Mt(this.$el, ":hover") || e && Mt(this.$el, ":focus") || this.toggle("toggle" + (w([wt, "focus"], t.type) ? "show" : "hide")))
            }
        }, {
            name: "click", filter: function () {
                ...
                var e;
                (Nt(t.target, 'a[href="#"], a[href=""]') || (e = Nt(t.target, "a[href]")) && (!ot(this.$el, "aria-expanded") || e.hash && Mt(this.target, e.hash))) && t.preventDefault(), this.toggle()
            }
        }, {
        ...
        update: {
            read: function () {
                ...
                var e = t.match, t = this.isToggled(this.target);
                (e ? !t : t) && this.toggle()
            }, events: ["resize"]
        },
        methods: {
            toggle: function (t) {
                ...
                ot(this.$el, "aria-expanded", M(t) ? t : this.cls ? He(this.target[0], this.cls.split(" ")[0]) : $t(this.target[0]))
            }
        }
    };
    ...
    function Ir(t) {
        var e = t.target, n = t.attributeName, t = ci(n);
    ...
    G(Object.freeze({
        ...
        }, {passive: !0, capture: !0}), r = 0, Jt(document, "animationstart", function (t) {
            t = t.target;
        ...
        document.body && Ae(document.body, kr), new MutationObserver(function (t) {
            ...
            return t.forEach(Ir)
        }).observe(document, {attributes: !0, subtree: !0}), yr._initialized = !0
    });
    lr = {
        mixins: [pi],
        ...
        update: {
            write: function () {
                ...
                r.total <= 0 && (this.stop(), r.days = r.hours = r.minutes = r.seconds = 0), this.units.forEach(function (t) {
                    var e = (e = String(Math.floor(r[t]))).length < 2 ? "0" + e : e, n = i[t];
    ...
    var Er = "uk-transition-leave", Tr = "uk-transition-enter";

    function Cr(t, s, a, u) {
        void 0 === u && (u = 0);
        var c = _r(s, !0), h = {opacity: 1}, l = {opacity: 0}, e = function (t) {
            return function () {
                return c === _r(s) ? t() : he.reject()
            }
        }, n = e(function () {
            return Be(s, Er), he.all(Mr(s).map(function (e, n) {
                return new he(function (t) {
            ...
            var o = cn(s);
            return Be(s, Tr), t(), Re(Ot(s), {opacity: 0}), new he(function (r) {
                return requestAnimationFrame(function () {
                    var t = Ot(s), e = cn(s);
                    ...
                    o !== e && i.push(Ze.start(s, {height: e}, a / 2 + n.length * u, "ease")), he.all(i).then(function () {
                        De(s, Tr), c === _r(s) && (Re(s, {
                            height: "",
                            alignContent: ""
                        }), Re(t, {opacity: ""}), delete s.dataset.transition), r()
                    })
                })
            })
        });
        return (He(s, Er) ? Ar(s) : He(s, Tr) ? Ar(s).then(n) : n()).then(e)
    }

    function _r(t, e) {
        return e && (t.dataset.transition = 1 + _r(t)), H(t.dataset.transition) || 0
    }
    ...
    function zr(t, d, f) {
        return new he(function (l) {
            return requestAnimationFrame(function () {
                var u = Ot(d), c = u.map(function (t) {
                    return Nr(t, !0)
                }), h = Re(d, ["height", "padding"]);
                Ze.cancel(d), u.forEach(Ze.cancel), Br(d), t(), u = u.concat(Ot(d).filter(function (t) {
                    return !w(u, t)
                })), he.resolve().then(function () {
                    gn.flush();
                    var n, i, r, t, e, o = Re(d, ["height", "padding"]),
                        e = (n = d, r = c, t = (i = u).map(function (t, e) {
                            return !!(Tt(t) && e in r) && (r[e] ? $t(t) ? Dr(t) : {opacity: 0} : {opacity: $t(t) ? 1 : 0})
                        }), e = t.map(function (t, e) {
                            e = Tt(i[e]) === n && (r[e] || Nr(i[e]));
                            return !!e && (t ? "opacity" in t || (e.opacity % 1 ? t.opacity = 1 : delete e.opacity) : delete e.opacity, e)
                        }), [t, e]), s = e[0], a = e[1];
                    u.forEach(function (t, e) {
                        return a[e] && Re(t, a[e])
                    }), Re(d, Y({display: "block"}, h)), requestAnimationFrame(function () {
    ...
    function Dr(t) {
        var e = sn(t), n = e.height, i = e.width, r = an(t), e = r.top, r = r.left,
    ...
    Bi = {
        ...
        methods: {
            animate: function (t, e) {
                ...
                return ("fade" === i ? Cr : "delayed-fade" === i ? function () {
                    for (var t = [], e = arguments.length; e--;) t[e] = arguments[e];
                    return Cr.apply(void 0, t.concat([40]))
                } : i ? zr : function () {
                    return t(), he.resolve()
        ...
        methods: {
            apply: function (t) {
                var e, n, i = this.getState(), t = Pr(t, this.attrItem, this.getState());
                ...
                void 0 === i && (i = !0), n = Y({
                    ...
                    return Le(t, r.cls, !!function (t, e, n) {
                        var i = n.filter;
                        void 0 === i && (i = {"": ""});
                        var r = n.sort, o = r[0], s = r[1], n = Or(t, e), r = n.filter;
                        void 0 === r && (r = "");
                        t = n.group;
                        void 0 === t && (t = "");
                        e = n.sort, n = n.order;
    ...
    function Pr(t, e, n) {
        var i = Or(t, e), r = i.filter, t = i.group, e = i.sort, i = i.order;
        return void 0 === i && (i = "asc"), (r || O(e)) && (t ? r ? (delete n.filter[""], n.filter[t] = r) : (delete n.filter[t], (D(n.filter) || "" in n.filter) && (n.filter = {"": r || ""})) : n.filter = {"": r || ""}), O(e) || (n.sort = [e, i]), n
    }

    xi = {
        slide: {
            show: function (t) {
                return [{transform: Lr(-100 * t)}, {transform: Lr()}]
            }, percent: Hr, translate: function (t, e) {
                return [{transform: Lr(-100 * e * t)}, {transform: Lr(100 * e * (1 - t))}]
            }
        }
    };
    ...
    var Fr = Y({}, xi, {
        fade: {
            ...
            show: function () {
                return [{opacity: 0, transform: jr(.8)}, {opacity: 1, transform: jr(1)}]
            }, percent: function (t) {
                return 1 - Re(t, "opacity")
            }, translate: function (t) {
                return [{opacity: 1 - t, transform: jr(1 - .2 * t)}, {opacity: t, transform: jr(.8 + .2 * t)}]
            }
        }
    });
    ...
    Zi = {
        mixins: [{
            ...
            props: {draggable: Boolean}, data: {draggable: !0, threshold: 10}, created: function () {
                ...
                start: function () {
                    this.drag = this.pos, this._transitioner ? (this.percent = this._transitioner.percent(), this.drag += this._transitioner.getDistance() * this.percent * this.dir, this._transitioner.cancel(), this._transitioner.translate(this.percent), this.dragging = !0, this.stack = []) : this.prevIndex = this.index, Jt(document, gt, this.move, {passive: !1}), Jt(document, vt + " " + xt + " input", this.end, !0), Re(this.list, "userSelect", "none")
                }, move: function (t) {
            ...
            show: function (t, e) {
                ...
                if (void 0 === e && (e = !1), !this.dragging && this.length) {
                    ...
                    if (i[e ? "unshift" : "push"](t), !e && 1 < i.length) 2 === i.length && this._transitioner.forward(Math.min(this.duration, 200)); else {
                        var s, a = this.getIndex(this.index), u = He(this.slides, this.clsActive) && this.slides[a],
                ...
                if (this._transitioner = this._getTransitioner(t, e, this.dir, Y({easing: n ? e.offsetWidth < 600 ? "cubic-bezier(0.25, 0.46, 0.45, 0.94)" : "cubic-bezier(0.165, 0.84, 0.44, 1)" : this.easing}, this.transitionOptions)), !n && !t) return this._translate(1), he.resolve();
                t = this.stack.length;
    ...
    var Qi = {
        ...
        data: {
            ...
            Transitioner: function (r, o, s, t) {
                var e = t.animation, a = t.easing, n = e.percent, i = e.translate,
                    u = (e = void 0 === (e = e.show) ? Q : e)(s), c = new ce;
                return {
                    dir: s, show: function (t, e, n) {
                        var i = this;
                        void 0 === e && (e = 0);
                        n = n ? "linear" : a;
                        return t -= Math.round(t * Z(e, -1, 1)), this.translate(e), Wr(o, "itemin", {
                            percent: e,
                            duration: t,
                            timing: n,
                            dir: s
                        ...
                        this.reset();
                        var e = i(t, s);
                        Re(o, e[1]), Re(r, e[0]), Wr(o, "itemtranslatein", {
                            percent: t,
                            dir: s
                        }), Wr(r, "itemtranslateout", {percent: 1 - t, dir: s})
                    }, percent: function () {
                        return n(r || o, o, s)
        ...
        created: function () {
            var t = Me(this.template), e = Me(this.selList, t);
        ...
        events: [{name: gt + " " + mt + " keydown", handler: "showControls"}, {
            ...
            name: "beforeitemshow", handler: function (t) {
                this.isToggled() || (this.draggable = !1, t.preventDefault(), this.toggleElement(this.$el, !0, !1), this.animation = Fr.scale, De(t.target, this.clsActive), this.stack.splice(1, 0, this.index))
            }
        }, {
            ...
            name: "itemload", handler: function (t, n) {
                ...
                void 0 === h && (h = {}), this.setItem(n, "<span uk-spinner></span>"), r && (a = {
                    ...
                    return i.setItem(n, qr("img", Y({src: r, width: e, height: t, alt: o}, h)))
                }, function () {
                    return i.setError(n)
                }) : "video" === e || r.match(/\.(mp4|webm|ogv)($|\?)/i) ? (Jt(u = qr("video", Y({
                    src: r,
                    poster: c,
                    controls: "",
                    playsinline: "",
                    ...
                    return i.setError(n)
                })) : "iframe" === e || r.match(/\.(html|php)($|\?)/i) ? this.setItem(n, qr("iframe", Y({
                    src: r,
                    frameborder: "0",
                    allowfullscreen: "",
                    class: "uk-lightbox-iframe"
                }, h))) : (s = r.match(/\/\/(?:.*?youtube(-nocookie)?\..*?[?&]v=|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)) ? this.setItem(n, qr("iframe", Y({
                    ...
                    return i.setItem(n, qr("iframe", Y({
    ...
    Ki = {
        install: function (t, e) {
            ...
            show: function (t) {
                var e, n = this, i = J(this.toggles.map(Ur), "source");
                return _(t) && (e = Ur(t).source, t = x(i, function (t) {
                    t = t.source;
                    return e === t
                })), this.panel = this.panel || this.$create("lightboxPanel", Y({}, this.$props, {items: i})), Jt(this.panel.$el, "hidden", function () {
                    return n.panel = !1
                }), this.panel.show(t)
            }, hide: function () {
    ...
    Gi = {
        ...
        connected: function () {
            var t, e = this, n = L(Re(this.$el, this.marginProp));
    ...
    var Yr = ["x", "y", "bgx", "bgy", "rotate", "scale", "color", "backgroundColor", "borderColor", "opacity", "blur", "hue", "grayscale", "invert", "saturate", "sepia", "fopacity", "stroke"],
        mr = {
            mixins: [dr], props: Yr.reduce(function (t, e) {
                return t[e] = "list", t
                ...
                read: function (t) {
                    ...
                    this.matchMedia && (t.image || !this.covers || !this.bgProps.length || (e = Re(this.$el, "backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/, "$1")) && ((n = new Image).src = e, (t.image = n).naturalWidth || (n.onload = function () {
                        ...
                        var e, n = h.props[t], i = n.diff, r = n.bgPos, o = n.steps,
                            n = "bgy" === t ? "height" : "width", s = c[n] - a[n];
                ...
                reset: function () {
                    ...
                    return Object.keys(d).reduce(function (t, e) {
                        var n = d[e], i = n.steps, r = n.unit, o = n.pos, s = function (t, e, n) {
                            void 0 === n && (n = 2);
                            var i = Xr(t, e), t = i[0], e = i[1], i = i[2];
                        ...
                        switch (e) {
                            ...
                            case"borderColor":
                                var a = Xr(i, l), u = a[0], c = a[1], h = a[2];
    ...
    function Xr(t, e) {
        var n = t.length - 1, i = Math.min(Math.floor(n * e), n - 1), i = t.slice(i, i + 2);
    ...
    function Gr(t, e, n) {
        var i = Zr(t, e);
        return n ? i - (t = t, on(e).width / 2 - on(t).width / 2) : Math.min(i, Kr(e))
    }

    function Kr(t) {
        return Math.max(0, Jr(t) - on(t).width)
    }
    ...
    Zi = {
        mixins: [pi, Zi, dr], props: {center: Boolean, sets: Boolean}, data: {
            center: !1,
            sets: !1,
            ...
            Transitioner: function (u, c, h, t) {
                var i = t.center, r = t.easing, l = t.list, o = new ce,
                    e = u ? Gr(u, l, i) : Gr(c, l, i) + on(c).width * h,
                    d = c ? Gr(c, l, i) : e + on(u).width * h * (lt ? -1 : 1);
                return {
                    dir: h, show: function (t, e, n) {
                        void 0 === e && (e = 0);
                        n = n ? "linear" : r;
                        return t -= Math.round(t * Z(e, -1, 1)), this.translate(e), e = u ? e : Z(e, 0, 1), to(this.getItemIn(), "itemin", {
                            percent: e,
                            duration: t,
                            timing: n,
                            dir: h
                        }), u && to(this.getItemIn(!0), "itemout", {
                            percent: 1 - e,
                            duration: t,
                            timing: n,
                            dir: h
                        }), Ze.start(l, {transform: Lr(-d * (lt ? -1 : 1), "px")}, t, n).then(o.resolve, Q), o.promise
                    }, cancel: function () {
                        Ze.cancel(l)
                    }, reset: function () {
                        Re(l, "transform", "")
                        ...
                        Re(l, "transform", Lr(Z(t - t * r - d, -Jr(l), on(l).width) * (lt ? -1 : 1), "px"));
                        var o = this.getActives(), s = this.getItemIn(), a = this.getItemIn(!0);
                        r = u ? Z(r, -1, 1) : 0, Ot(l).forEach(function (t) {
                            var e = w(o, t), n = t === s, i = t === a;
                            to(t, "itemtranslate" + (n || !i && (e || h * (lt ? -1 : 1) == -1 ^ Zr(t, l) > Zr(u || c)) ? "in" : "out"), {
                                dir: h,
                        ...
                        void 0 === t && (t = !1);
                        var e = this.getActives(), n = Qr(l, Gr(c || u, l, i));
                        return t && (t = e, e = n, n = t), n[x(n, function (t) {
                            return !w(e, t)
                        })]
                    }, getActives: function () {
                        return Qr(l, Gr(u || c, l, i))
                    }
                }
            }
        }, computed: {
            avgWidth: function () {
                ...
                return t.finite || Math.ceil(Jr(this.list)) < on(this.list).width + (t = this.list, Math.max.apply(Math, [0].concat(Ot(t).map(function (t) {
                    return on(t).width
                })))) + this.center
            }, maxIndex: function () {
                if (!this.finite || this.center && !this.sets) return this.length - 1;
                if (this.center) return X(this.sets);
                var e = 0, n = Kr(this.list), t = x(this.slides, function (t) {
                ...
                var r = this;
                if (t = t.sets) {
                    var o = on(this.list).width / (this.center ? 2 : 1), s = 0, a = o, u = 0;
            ...
            beforeitemshow: function (t) {
                ...
                if (!this.dragging && 1 < e) {
                    ...
                    this.duration = Vr(this.avgWidth / this.velocity) * (on(this.slides[t]).width / this.avgWidth), this.reorder()
                }
            }, itemshow: function () {
    ...
    mr = {
        mixins: [mr], data: {selItem: "!li"}, computed: {
            item: function (t, e) {
            ...
            name: "itemin itemout", self: !0, el: function () {
                ...
                var n = this, i = t.type, t = t.detail, r = t.percent, o = t.duration, s = t.timing, a = t.dir;
                gn.read(function () {
                    var t = n.getCss(no(i, a, r)), e = n.getCss(eo(i) ? .5 : 0 < a ? 1 : 0);
                    gn.write(function () {
            ...
            name: "itemtranslatein itemtranslateout", self: !0, el: function () {
                ...
                var e = this, n = t.type, t = t.detail, i = t.percent, r = t.dir;
                gn.read(function () {
                    var t = e.getCss(no(n, r, i));
                    gn.write(function () {
                        return Re(e.$el, t)
                    })
                })
    ...
    function no(t, e, n) {
        return n /= 2, eo(t) ? e < 0 ? 1 - n : n : e < 0 ? n : 1 - n
    }
    ...
    var io, xi = Y({}, xi, {
        fade: {
            ...
            show: function () {
                return [{opacity: 0, transform: jr(1.5), zIndex: 0}, {zIndex: -1}]
            }, percent: function (t) {
                return 1 - Re(t, "opacity")
            }, translate: function (t) {
                return [{opacity: 1 - t, transform: jr(1 + .5 * t), zIndex: 0}, {zIndex: -1}]
            }
        }, pull: {
            show: function (t) {
                return t < 0 ? [{transform: Lr(30), zIndex: -1}, {transform: Lr(), zIndex: 0}] : [{
                    transform: Lr(-100),
                    zIndex: 0
                }, {transform: Lr(), zIndex: -1}]
            }, percent: function (t, e, n) {
                return n < 0 ? 1 - Hr(e) : Hr(t)
            }, translate: function (t, e) {
                return e < 0 ? [{transform: Lr(30 * t), zIndex: -1}, {
                    transform: Lr(-100 * (1 - t)),
                    zIndex: 0
                }] : [{transform: Lr(100 * -t), zIndex: 0}, {transform: Lr(30 * (1 - t)), zIndex: -1}]
            }
        }, push: {
            show: function (t) {
                return t < 0 ? [{transform: Lr(100), zIndex: 0}, {transform: Lr(), zIndex: -1}] : [{
                    transform: Lr(-30),
                    zIndex: -1
                }, {transform: Lr(), zIndex: 0}]
            }, percent: function (t, e, n) {
                return 0 < n ? 1 - Hr(e) : Hr(t)
            }, translate: function (t, e) {
                return e < 0 ? [{transform: Lr(100 * t), zIndex: 0}, {
                    transform: Lr(-30 * (1 - t)),
                    zIndex: -1
                }] : [{transform: Lr(-30 * t), zIndex: -1}, {transform: Lr(100 * (1 - t)), zIndex: 0}]
            }
        }
    }), xi = {
        mixins: [pi, Qi, dr],
        ...
        update: {
            read: function () {
                var t = this.ratio.split(":").map(Number), e = t[0], t = (t = t[1]) * this.list.offsetWidth / e || 0;
                ...
                this.drag && Tt(this.placeholder) && (e = (n = this.pos).x, a = n.y, s = (i = this.origin).offsetTop, r = i.offsetLeft, n = this.placeholder, Re(this.drag, {
                    ...
                    if (Ot(t).length) {
                        ...
                        if (!o) return function (t, e) {
                            var n = 1 === Ot(t).length;
                            n && be(t, e);
                            var i = Ot(t), t = i.some(function (t, e) {
                                var n = t.getBoundingClientRect();
                                return i.slice(e + 1).some(function (t) {
                                    t = t.getBoundingClientRect();
                                    return !ro([n.left, n.right], [t.left, t.right])
                                })
                            });
                            n && $e(e);
                            return t
                        }(t, n) || r < s.top + s.height / 2 ? e : e.nextElementSibling;
                        o = n.getBoundingClientRect(), t = ro([s.top, s.bottom], [o.top, o.bottom]), n = t ? i : r, i = t ? "width" : "height", r = t ? "left" : "top", t = t ? "right" : "bottom", i = o[i] < s[i] ? s[i] - o[i] : 0;
        ...
        methods: {
            init: function (t) {
                ...
                }), Be(this.drag, this.clsDrag, this.clsCustom), Be(this.placeholder, this.clsPlaceholder), Be(this.items, this.clsItem), Be(document.documentElement, this.clsDragState), te(this.$el, "start", [this, this.placeholder]), e = this.pos, n = Date.now(), io = setInterval(function () {
                    var t = e.x, s = e.y;
                    s += window.pageYOffset;
                    var a = .3 * (Date.now() - n);
                    n = Date.now(), Vn(document.elementFromPoint(t, e.y)).reverse().some(function (t) {
                        var e = t.scrollTop, n = t.scrollHeight, i = sn(Rn(t)), r = i.top, o = i.bottom, i = i.height;
                ...
                Zt(document, gt, this.move), Zt(document, vt, this.end), Zt(window, "scroll", this.scroll), this.drag && (clearInterval(io), t = this.getSortable(this.placeholder), this === t ? this.origin.index !== Pt(this.placeholder) && te(this.$el, "moved", [this, this.placeholder]) : (te(t.$el, "added", [t, this.placeholder]), te(this.$el, "removed", [this, this.placeholder])), te(this.$el, "stop", [this, this.placeholder]), $e(this.drag), this.drag = null, this.touched.forEach(function (t) {
                    var e = t.clsPlaceholder, n = t.clsItem;
    ...
    bt = {
        ...
        events: ((Si = {focus: "show", blur: "hide"})[wt + " " + bt] = function (t) {
    ...
    Si = {
        ...
        events: {
            change: function (t) {
                ...
                so(t), Be(this.$el, this.clsDragover)
            }, dragleave: function (t) {
                so(t), De(this.$el, this.clsDragover)
            }
        },
        methods: {
            upload: function (t) {
                ...
                if (t.length) {
                    ...
                    for (var e = 0; e < t.length; e++) {
                        ...
                        if (this.allow && !oo(this.allow, t[e].name)) return void this.fail(this.msgInvalidName.replace("%s", this.allow));
                        if (this.mime && !oo(this.mime, t[e].type)) return void this.fail(this.msgInvalidMime.replace("%s", this.mime))
                    }
                    ...
                    var r = function (t, e) {
                        ...
                        me(i.url, {
                            data: n, method: i.method, responseType: i.type, beforeSend: function (t) {
                                var e = t.xhr;
